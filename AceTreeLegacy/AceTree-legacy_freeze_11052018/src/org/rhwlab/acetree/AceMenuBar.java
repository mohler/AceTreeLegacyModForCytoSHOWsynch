...
//        menu.add(i3DViewer);
   ...
   //     menu.add(i3Dsave);
	...
	public void actionPerformed(ActionEvent e) {
		...
		ImagePlus imp=ij.IJ.openImage(iAceTree.getImageWindowAT().getCurrentImageName());
		imp.show();
		//FileInfo fi = new FileInfo();
		//fi.fileName = iAceTree.getImageWindowAT().getCurrentImageName();
	    ...
	    //iAceTree.getImageWindowAT().launchImageParamsDialog();
