...
public class AceTreeNoUI {
    ...
    public  ImageWindowNoUI 		iImgWinNoUI;
    ...
    */
    ...
    public void setStartingCell(Cell c, int time) {
        ...
        iImgWinNoUI.refreshDisplay(null);
    }
    ...
    private int trackCellPlane() {
        if (iTrackPosition != ImageWindowAT.NONE) {
            iPlaneInc = 0;
        ...
        if (cfile == null) {
            ...
            if (iImgWinNoUI != null) {
                try {
                    ...
                    ip = iImgWinNoUI.refreshDisplay(iTifPrefix + cfile);
                } catch(Exception e) {
                ...
                iImgWinNoUI = new ImageWindowNoUI(iTifPrefix + cfile, ip);
                iImgWinNoUI.setAceTree(this);
                ip = iImgWinNoUI.refreshDisplay(iTifPrefix + cfile);
    ...
    public void addMainAnnotation() {
        ...
        iImgWinNoUI.addAnnotation(iCurrentCellXloc, iCurrentCellYloc, true);
    }
