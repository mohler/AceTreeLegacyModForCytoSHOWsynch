...
public class NucleiMgrHeadless extends NucleiMgr {
	...
	*/
    ...
    private void findImageParameters() {
        ...
        String zipTifFilePath = iImgWin.cZipTifFilePath;
        String tifPrefix = iImgWin.cTifPrefix;
        String tifPrefixR = iImgWin.cTifPrefixR;
        int useZip = iImgWin.cUseZip;
        int width = iImgWin.cImageHeight;
        int height = iImgWin.cImageWidth;
        ...
        // now "make" the image
        iImgWin.makeImage(getConfig().iTifPrefix + imageName);
        iImageWidth = iImgWin.cImageWidth;
        iImageHeight = iImgWin.cImageHeight;
        // now restore ImageWindow
        iImgWin.cZipTifFilePath = zipTifFilePath;
        iImgWin.cTifPrefix = tifPrefix;
        iImgWin.cTifPrefixR = tifPrefixR;
        iImgWin.cUseZip = useZip;
        iImgWin.cImageWidth = width;
        iImgWin.cImageHeight = height;
    }
