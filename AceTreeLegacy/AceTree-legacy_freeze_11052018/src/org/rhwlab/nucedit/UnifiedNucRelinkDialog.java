...
public class UnifiedNucRelinkDialog extends NucRelinkDialog{
	...
	public void processMouseEvent(MouseEvent e){
    	...
    	if(addKeyframeActive&iWarned.isSelected()){
			...
			Nucleus itself = iImgWin.cNucleiMgr.findClosestNucleusXYZ(x, y, z, time);
    ...
    protected String addCell(int x, int y) {
		...
		//	Nucleus nclose = iImgWin.cNucleiMgr.findClosestNucleus(x,y,plane,time);
		...
		iAceTree.getImageWindowAT().addAnnotation(x, y, true);
		return(n.identity);
    }
