...
public class DeathsAdjacencies extends JDialog implements ActionListener, ListSelectionListener, Comparator {
	...
	private void test1() {
        ...
        ImageWindowAT imgWin = iAceTree.getImageWindowAT();
    ...
    private void addItems(Vector vv, ImageWindowAT imgWin) {
	...
	public void valueChanged(ListSelectionEvent e) {
        ...
        if (e.getValueIsAdjusting() == false) {
            ...
            bringUpImageWindowAT(name);
        }

    }

    private void bringUpImageWindowAT(String name) {
        Vector v = new Vector();
        v.add("InputCtrl1");
