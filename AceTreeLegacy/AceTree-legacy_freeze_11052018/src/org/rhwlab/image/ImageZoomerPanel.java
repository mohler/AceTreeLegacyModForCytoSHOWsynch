       ...
       implements ActionListener
{
     ...
     * @param imageName
     */
    public ImageZoomerPanel(ImageWindowAT imgWin, Image image, double zoomPercentage, String imageName, PlayerControl playercontrol)
    {
    ...
    public ImageZoomerPanel(ImageWindowATstatic imageWindowATstatic, Image image, double zoomPercentage,
			String title, PlayerControl playercontrol) {
