       ...
       implements MouseListener, ActionListener
{
     ...
     * @param imageName
     */
    public ImageZoomerFrame(ImageWindowAT imgWin, Image image, double zoomPercentage, String imageName)
    {
...
m_imagePanel.addKeyListener(iImgWin); //added to make zoom window respond to key events -AS 11/23/11
    ...
    public ImageZoomerFrame(ImageWindowATstatic imageWindowATstatic, Image image, double zoomPercentage,
			String title) {
