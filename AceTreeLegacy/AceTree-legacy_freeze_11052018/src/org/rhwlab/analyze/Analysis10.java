...
public class Analysis10 extends Log {
    ...
    NucleiMgr       iNucleiMgr;       ImageWindowAT       iImgWin;
    ...
    private void test2() {
        ...
        //ByteProcessor bp = new ByteProcessor(iImgWin.cImageWidth, iImgWin.cImageHeight);
    ...
    private ImagePlus getOneXZ(int time, int x) {
        int planeEnd = iNucleiMgr.getPlaneEnd();
        ByteProcessor bp = new ByteProcessor(11 * planeEnd - 1, iImgWin.cImageHeight);
    ...
    private ImagePlus getOneYZ(int time, int y) {
        int planeEnd = iNucleiMgr.getPlaneEnd();
        ByteProcessor bp = new ByteProcessor(iImgWin.cImageWidth, 11 * planeEnd - 1);
        for (int m=1; m <= planeEnd; m++) {
            ImageProcessor ip = getImage(time, m);
