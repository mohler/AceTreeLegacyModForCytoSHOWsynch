...
import org.rhwlab.acetree.AceTreeBatch;
...
public class VTree implements ActionListener {
    ...
    public VTree(AceTree aceTree) {
    	this(aceTree, true);
    }
    public VTree(AceTree aceTree, boolean display) {
    	iAceTree = aceTree;
    ...
    public static void main(String[] args) {
        new VTree(new AceTree(args[0], false));
    }
	...
	public void actionPerformed(ActionEvent e) {
        ...
        if (o == iShow) {
            ...
            if (iVTreeImpl == null) iVTreeImpl = new VTreeImpl(iAceTree);
    ...
    public VTreeImpl getiVTreeImpl() {
        if (iVTreeImpl == null) 
        	iVTreeImpl = new VTreeImpl(iAceTree);
		return iVTreeImpl;
	}
	public void setiVTreeImpl(VTreeImpl iVTreeImpl) {
		this.iVTreeImpl = iVTreeImpl;
	}
